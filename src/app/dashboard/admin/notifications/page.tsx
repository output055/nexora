  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold text-white mb-2">Notifications Inbox</h1>
          <p className="text-slate-400">All system alerts, payment logs, and events.</p>
        </div>
        {unreadCount > 0 && (
          <button 
      ...
      <div className="bg-[#1E293B] border border-white/10 rounded-2xl overflow-hidden">
        {notifications.length === 0 ? (
          <div className="p-16 text-center text-slate-500">
            ...
            <p className="text-sm max-w-md mx-auto">You don't have any notifications at the moment. System events will appear here.</p>
          </div>
        ) : (
