-- Seed Customers
insert into public.customers (full_name, phone_number, os_platform, device_model, miradore_device_id, total_owed, remaining_balance, payment_status) values
...
on conflict (miradore_device_id) do nothing;
